...
public class ModItems {
    ...
    //Register Item
    public static final RegistryObject<Item> TEST_TUBE = ITEMS.register("test_tube", () -> new Item(new Item.Properties()));

    /*public static final RegistryObject<Item> LIQUID_IRON = ITEMS.register("liquid_iron", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> LIQUID_ALUMINUM = ITEMS.register("liquid_aluminum", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> LIQUID_COPPER = ITEMS.register("liquid_copper", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> LIQUID_LEAD = ITEMS.register("liquid_lead", () -> new Item(new Item.Properties()));*/
