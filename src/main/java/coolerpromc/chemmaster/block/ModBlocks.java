...
*/
    public static final RegistryObject<Block> FLUID_SEPARATOR = registerBlock("fluid_separator",
            () -> new FluidSeparatorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
    public static final RegistryObject<Block> ORE_PROCESSING_STATION = registerBlock("ore_processing_station",
            () -> new OreProcessingStationBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
    public static final RegistryObject<Block> AIR_COOLER = registerBlock("air_cooler",
            () -> new AirCoolerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
